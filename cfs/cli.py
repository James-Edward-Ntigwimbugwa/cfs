...
def get_framework_modules(template_name: str) -> Tuple[Type, Type]:
    ...
    match template_name:
        ...
        case 'django':
            try:
                from cfs.modules.templates.django.core.django_generator import DjangoGenerator
                from cfs.modules.templates.django.core.django_manifest_loader import DjangoManifestLoader
        ...
        case _:
            raise ImportError(
                ...
                f"Supported frameworks: springboot, flutter, django, react, nextjs, fastapi, express, vue"
            )
