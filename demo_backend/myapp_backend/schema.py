...
from myapp.log_exceptions import log_exceptions
...
module_classes = [
    ('myapp_accounts', "Query", "Mutation"),
    ('myapp_files', "Query", "Mutation"),
    ('myapp_settings', "Query", "Mutation"),
    ('myapp_subsidy_management', "Query", "Mutation"),
    ('myapp_vendor_management', "Query", "Mutation"),
]
