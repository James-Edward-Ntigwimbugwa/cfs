...
from myapp_settings.models import Regions, Districts, Wards, Streets

region_path = "myapp_assets/locations/Regions.csv"
district_path = "myapp_assets/locations/Districts.csv"
ward_path = "myapp_assets/locations/Wards.csv"
street_path = "myapp_assets/locations/Streets.csv"
...
class Command(BaseCommand):
    ...
    def _display_summary(self, stats):
        ...
        self.stdout.write(self.style.SUCCESS(
            "Database populated successfully. 🌱" * 10))
